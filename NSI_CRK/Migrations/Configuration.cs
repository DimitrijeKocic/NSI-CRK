namespace NSI_CRK.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CRKContext>
    {
        ...
        protected override void Seed(CRKContext context)
        {
            ...
            {
                new Payment { Amount = 1000, Type = PaymentType.FixSalary, Month = Months.May, Date = DateTime.Parse("2020-06-10"),
                ...
                new Payment { Amount = 1700, Type = PaymentType.FixSalary, Month = Months.May, Date = DateTime.Parse("2020-06-10"),
                    EmployeeID = employees.Single(e => (e.FirstName == "Milan" && e.LastName == "Stojaković")).ID },
                new Payment { Amount = 2500, Type = PaymentType.FixSalary, Month = Months.May, Date = DateTime.Parse("2020-06-10"),
                    EmployeeID = employees.Single(e => (e.FirstName == "Milan" && e.LastName == "Rajković")).ID },
                new Payment { Amount = 3000, Type = PaymentType.FixSalary, Month = Months.May, Date = DateTime.Parse("2020-06-10"),
                ...
                new Payment { Amount = 4000, Type = PaymentType.FixSalary, Month = Months.May, Date = DateTime.Parse("2020-06-10"),
                    EmployeeID = employees.Single(e => (e.FirstName == "Dejan" && e.LastName == "Đorđević")).ID },
                new Payment { Amount = 150, Type = PaymentType.TransportSubsidy, Date = DateTime.Parse("2020-06-15"),
                    EmployeeID = employees.Single(e => (e.FirstName == "Stefan" && e.LastName == "Kojić")).ID },
                new Payment { Amount = 200, Type = PaymentType.OvertimeWork, Date = DateTime.Parse("2020-06-20"),
                    EmployeeID = employees.Single(e => (e.FirstName == "Vladan" && e.LastName == "Petković")).ID },
                new Payment { Amount = 250, Type = PaymentType.OvertimeWork, Date = DateTime.Parse("2020-06-20"),
                    EmployeeID = employees.Single(e => (e.FirstName == "Slobodan" && e.LastName == "Micić")).ID },
                new Payment { Amount = 200, Type = PaymentType.OvertimeWork, Date = DateTime.Parse("2020-06-21"),
                    EmployeeID = employees.Single(e => (e.FirstName == "Stefan" && e.LastName == "Kojić")).ID },
                new Payment { Amount = 750, Type = PaymentType.Other, Date = DateTime.Parse("2020-06-15"),
                    EmployeeID = employees.Single(e => (e.FirstName == "Milan" && e.LastName == "Rajković")).ID }
            };
            ...
            {
                new Absence { Type = AbsenceType.PaidVacation, BeginDate = DateTime.Parse("2020-05-11"), EndDate = DateTime.Parse("2020-05-22"),
                    NumberOfDays = 10, EmployeeID = employees.Single(e => (e.FirstName == "Slobodan" && e.LastName == "Micić")).ID },
                new Absence { Type = AbsenceType.PaidVacation, BeginDate = DateTime.Parse("2020-06-01"), EndDate = DateTime.Parse("2020-06-08"),
                    NumberOfDays = 6, EmployeeID = employees.Single(e => (e.FirstName == "Vladan" && e.LastName == "Petković")).ID },
                new Absence { Type = AbsenceType.PaidVacation, BeginDate = DateTime.Parse("2020-06-04"), EndDate = DateTime.Parse("2020-06-09"),
                    NumberOfDays = 4, EmployeeID = employees.Single(e => (e.FirstName == "Stefan" && e.LastName == "Kojić")).ID },
                new Absence { Type = AbsenceType.PaidVacation, BeginDate = DateTime.Parse("2020-06-08"), EndDate = DateTime.Parse("2020-06-17"),
                    NumberOfDays = 8, EmployeeID = employees.Single(e => (e.FirstName == "Milan" && e.LastName == "Rajković")).ID },
                new Absence { Type = AbsenceType.SickDays, BeginDate = DateTime.Parse("2020-06-16"), EndDate = DateTime.Parse("2020-06-24"),
                    NumberOfDays = 7, EmployeeID = employees.Single(e => (e.FirstName == "Stefan" && e.LastName == "Kojić")).ID },
                new Absence { Type = AbsenceType.ParentalLeave, BeginDate = DateTime.Parse("2020-06-27"), EndDate = DateTime.Parse("2020-06-30"),
                    NumberOfDays = 4, EmployeeID = employees.Single(e => (e.FirstName == "Stefan" && e.LastName == "Kojić")).ID },
                new Absence { Type = AbsenceType.UnpaidVacation, BeginDate = DateTime.Parse("2020-06-29"), EndDate = DateTime.Parse("2020-07-09"),
                    NumberOfDays = 9, EmployeeID = employees.Single(e => (e.FirstName == "Slobodan" && e.LastName == "Micić")).ID },
                new Absence { Type = AbsenceType.PaidVacation, BeginDate = DateTime.Parse("2020-01-07"), EndDate = DateTime.Parse("2020-07-10"),
                    NumberOfDays = 8, EmployeeID = employees.Single(e => (e.FirstName == "Milan" && e.LastName == "Stojaković")).ID },
                new Absence { Type = AbsenceType.SickDays, BeginDate = DateTime.Parse("2020-07-13"), EndDate = DateTime.Parse("2020-07-17"),
                    NumberOfDays = 5, EmployeeID = employees.Single(e => (e.FirstName == "Milan" && e.LastName == "Stojaković")).ID },
            };
